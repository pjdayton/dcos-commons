...
public class TaskVolumesCannotChangeTest {
    ...
    private static final VolumeSpec VOLUME1 = new DefaultVolumeSpec(
            DISK_SIZE_MB, VolumeSpec.Type.MOUNT, null, "/path/to/volume", "role", "principal", "VOLUME");
    private static final VolumeSpec VOLUME2 = new DefaultVolumeSpec(
            DISK_SIZE_MB + 3, VolumeSpec.Type.MOUNT, null, "/path/to/volume", "role", "principal", "VOLUME");
    private static final VolumeSpec VOLUME3 = new DefaultVolumeSpec(
            DISK_SIZE_MB, VolumeSpec.Type.ROOT, null, "/path/to/volume", "role", "principal", "VOLUME");
